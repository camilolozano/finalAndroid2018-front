...
import { Events } from './myEvents.model';
// Statics
...
export class MyEventsService {
  ...
  private urlListMyEvents: string;
  ...
  constructor(
    ...
    this.urlListMyEvents = `${server}/events/my-events`;
    this.urlDownloadXlsx = `${server}/events/download`;
  }

  getListMyEvents(idUser): Observable<Events[]> {
    const url = `${this.urlListMyEvents}/${idUser}`;
